...
[返回总目录](../README.md) · [上一章](../第08章-异常控制流/README.md) · [下一章](../第10章-系统级IO/README.md) · [按小节阅读](README.md) · [练习题答案](练习题答案.md)
...
- [第 9 章 虚拟内存](#第-9-章-虚拟内存)
  ...
  - [9.7 案例研究：Intel Core i7/Linux 内存系统](#97-案例研究intel-core-i7linux-内存系统)
  ...
  - [9.10 垃圾收集](#910-垃圾收集)
    ...
    - [9.10.2 Mark & Sweep 垃圾收集器](#9102-mark--sweep-垃圾收集器)
    - [9.10.3 C 程序的保守 Mark & Sweep](#9103-c-程序的保守-mark--sweep)
...
![一个 VM 系统是如何使用主存作为缓存的](9.3/assets/fig-9-3-dram-as-vm-cache.png)
...
![页表](9.3/assets/fig-9-4-page-table.png)
...
![VM 页命中](9.3/assets/fig-9-5-vm-page-hit.png)
...
![VM 缺页之前](9.3/assets/fig-9-6-vm-page-fault-before.png)
...
![VM 缺页之后](9.3/assets/fig-9-7-vm-page-fault-after.png)
...
![分配一个新的虚拟页面](9.3/assets/fig-9-8-allocating-virtual-page.png)
...
![VM 如何为进程提供独立的地址空间](9.4/assets/fig-9-9-independent-address-spaces.png)
...
![用虚拟内存来提供页面级的内存保护](9.5/assets/fig-9-10-page-level-memory-protection.png)
...
![使用页表的地址翻译](9.6/assets/fig-9-12-address-translation-with-page-table.png)
...
![页面命中和缺页的操作图](9.6/assets/fig-9-13-page-hit-and-page-fault.png)
...
![将 VM 与物理寻址的高速缓存结合起来](9.6/assets/fig-9-14-physical-cache-with-vm.png)
...
![TLB 命中和不命中的操作图](9.6/assets/fig-9-16-tlb-hit-and-miss.png)
...
![一个两级页表层次结构](9.6/assets/fig-9-17-two-level-page-table.png)
...
![使用 K 级页表的地址翻译](9.6/assets/fig-9-18-k-level-address-translation.png)
...
![小内存系统的寻址](9.6/assets/fig-9-19-small-memory-addressing.png)
...
![小内存系统的 TLB、页表以及缓存](9.6/assets/fig-9-20-small-memory-system.png)
...
![Core i7 的内存系统](9.7/assets/fig-9-21-core-i7-memory-system.jpg)
...
![Core i7 地址翻译的概况](9.7/assets/fig-9-22-core-i7-address-translation.jpg)
...
![第一级、第二级和第三级页表条目格式](9.7/assets/fig-9-23-level-1-2-3-pte-format.jpg)
...
![第四级页表条目的格式](9.7/assets/fig-9-24-level-4-pte-format.jpg)
...
![Core i7 页表翻译](9.7/assets/fig-9-25-core-i7-page-table-translation.jpg)
...
![一个 Linux 进程的虚拟内存](9.7/assets/fig-9-26-linux-process-virtual-memory.jpg)
...
![Linux 是如何组织虚拟内存的](9.7/assets/fig-9-27-linux-virtual-memory-organization.jpg)
...
![Linux 缺页处理](9.7/assets/fig-9-28-linux-page-fault-handling.jpg)
...
![一个共享对象](9.8/assets/fig-9-29-shared-object.jpg)
...
![一个私有的写时复制对象](9.8/assets/fig-9-30-private-copy-on-write-object.jpg)
...
![加载器是如何映射用户地址空间的区域的](9.8/assets/fig-9-31-loader-mappings.jpg)
...
![mmap 参数的可视化解释](9.8/assets/fig-9-32-mmap-parameters.jpg)
...
![堆](9.9/assets/fig-9-33-heap.png)
...
![用 malloc 和 free 分配和释放块](9.9/assets/fig-9-34-malloc-free-blocks.png)
...
![一个简单的堆块的格式](9.9/assets/fig-9-35-simple-heap-block-format.png)
...
![用隐式空闲链表来组织堆](9.9/assets/fig-9-36-implicit-free-list.png)
...
![分割一个空闲块](9.9/assets/fig-9-37-splitting-free-block.png)
...
![假碎片的示例](9.9/assets/fig-9-38-false-fragmentation.png)
...
![使用边界标记的堆块的格式](9.9/assets/fig-9-39-boundary-tag-block-format.png)
...
![使用边界标记的合并](9.9/assets/fig-9-40-boundary-tag-coalescing.png)
...
![隐式空闲链表的恒定形式](9.9/assets/fig-9-42-implicit-free-list-invariant.png)
...
![使用双向空闲链表的堆块的格式](9.9/assets/fig-9-48-doubly-linked-free-list-block-format.png)
...
![垃圾收集器将内存视为一张有向图](9.10/assets/fig-9-49-reachability-graph.png)
...
![将一个保守的垃圾收集器加入到 C 的 malloc 包中](9.10/assets/fig-9-50-conservative-gc.png)
...
![Mark&Sweep 示例](9.10/assets/fig-9-52-mark-and-sweep-example.png)
...
![一棵已分配块的平衡树中的左右指针](9.10/assets/fig-9-53-balanced-tree-pointers.png)
