...
![图 4-71 练习题 4.10 的答案](assets/fig-4-71.jpg)
...
| --- | --- | --- |
| 取指 | icode:ifun ← M₁[PC]<br>rA:rB ← M₁[PC+1]<br>valC ← M₈[PC+2]<br>valP ← PC+10 | icode:ifun ← M₁[0x016] = 3:0<br>rA:rB ← M₁[0x017] = f:4<br>valC ← M₈[0x018] = 128<br>valP ← 0x016+10 = 0x020 |
| 译码 | | |
...
| --- | --- | --- |
| 取指 | icode:ifun ← M₁[PC]<br>rA:rB ← M₁[PC+1]<br>valP ← PC+2 | icode:ifun ← M₁[0x02c] = b:0<br>rA:rB ← M₁[0x02d] = 0:f<br>valP ← 0x02c+2 = 0x02e |
...
| --- | --- | --- |
| 取指 | icode:ifun ← M₁[PC]<br>valC ← M₈[PC+1]<br>valP ← PC+9 | icode:ifun ← M₁[0x037] = 8:0<br>valC ← M₈[0x038] = 0x041<br>valP ← 0x037+9 = 0x040 |
